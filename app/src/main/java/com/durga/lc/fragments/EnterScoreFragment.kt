 ...
 * [EnterScoreFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [EnterScoreFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class EnterScoreFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater!!.inflate(R.layout.fragment_enter_score, container, false)
        ...
        submit_values.setOnClickListener {
            ...
            if (mem1Val != null && mem1Val.equals("") && mem2Val != null && mem2Val.equals("") && mem3Val != null && mem3Val.equals("") &&
                mem4Val != null && mem4Val.equals("") && mem5Val != null && mem5Val.equals("") && mem6Val != null && mem6Val.equals("") &&
                mem7Val != null && mem7Val.equals("") && mem8Val != null && mem8Val.equals("")) {

                showCommonAlert(context,"Please enter scores")
            } else {
                ...
                databaseHandler.insertSCORES(userScores)
                showCommonAlert(context, "Score added successfully !")
            }
        }
        view_values.setOnClickListener {


            loadFragment(ViewScoreFragment())
        }
        return view;
    }
